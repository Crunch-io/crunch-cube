...
class DescribeFrozenSlice:
    ...
    def it_calculates_row_proportions_with_and_without_hs(self):
        ...
        # Without insertions
        slice_ = FrozenCube(
            CR.CAT_X_CAT_PRUNING_HS, transforms=transforms, weighted=False
        ).slices[0]
        expected = np.array(
            [
        ...
        slice_ = FrozenCube(CR.CAT_X_CAT_PRUNING_HS, weighted=False).slices[0]
        expected = np.array(
            [
    ...
    def it_calculates_mr_x_cat_row_proportions(self):
        slice_ = FrozenCube(CR.MR_X_CAT_HS, weighted=False).slices[0]
        expected = [
            [
                0.30769231,
                0.26923077,
    ...
    def it_calculates_cat_x_mr_row_proportions(self):
        slice_ = FrozenCube(CR.CAT_X_MR_HS, weighted=False).slices[0]
        expected = np.array(
            [
    ...
    def it_calculates_mr_x_mr_row_proportions(self):
        slice_ = FrozenCube(CR.MR_X_MR, weighted=False).slices[0]
        expected = [
