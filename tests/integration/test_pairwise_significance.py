...
class TestStandardizedResiduals(TestCase):
    ...
    def test_cat_hs_x_mr_augmented_wgtd(self):
        ...
        np.testing.assert_array_almost_equal(
            ...
            np.array(
                [
                    [np.nan, 0.0, -12.03291501],
                    [np.nan, 0.0, 10.3873348],
                    [np.nan, 0.0, -12.54926887],
                    [np.nan, 0.0, -4.98846103],
                    [np.nan, 0.0, 2.68859716],
                    [np.nan, 0.0, 0.06112212],
                    [np.nan, 0.0, 9.15552354],
                    [np.nan, 0.0, 5.45204147],
                    [np.nan, 0.0, 1.97874262],
                    [np.nan, 0.0, 5.66822343],
                ]
            ),
        )
        np.testing.assert_array_almost_equal(
            ...
            np.array(
                [
                    ...
                    [np.nan, 1.00000000e00, 0.00000000e00],
                    [np.nan, 1.00000000e00, 0.00000000e00],
                    [np.nan, 1.00000000e00, 6.20047861e-07],
                    [np.nan, 1.00000000e00, 7.18855840e-03],
                    [np.nan, 1.00000000e00, 9.51263315e-01],
                    [np.nan, 1.00000000e00, 0.00000000e00],
                    [np.nan, 1.00000000e00, 5.11174763e-08],
                    [np.nan, 1.00000000e00, 4.78755429e-02],
                    [np.nan, 1.00000000e00, 1.48751298e-08],
                ]
            ),
        )
        ...
        np.testing.assert_array_almost_equal(
            ...
            [
                [np.nan, 0.01044491, 0.01066104],
                [np.nan, 0.01043834, 0.01215179],
                [np.nan, 0.00860228, 0.0066323],
                [np.nan, 0.0100921, 0.00903143],
                [np.nan, 0.01037591, 0.01315062],
                [np.nan, 0.01047663, 0.01246996],
                [np.nan, 0.00889774, 0.00878264],
                [np.nan, 0.008413, 0.00840329],
                [np.nan, 0.00100287, 0.00104038],
                [np.nan, 0.00844888, 0.00844599],
            ],
        )
        np.testing.assert_array_almost_equal(
            correction_factor,
            [
                [1.14862195e-04, 0.00000000e00, -3.96180863e-06],
                [1.34527496e-04, 0.00000000e00, -3.79240027e-05],
                [7.82954852e-05, 0.00000000e00, 1.79881140e-05],
                [1.17440089e-04, 0.00000000e00, 1.73302564e-05],
                [1.26316368e-04, 0.00000000e00, -6.65160522e-05],
                [1.33320462e-04, 0.00000000e00, -4.53163999e-05],
                [8.59906735e-05, 0.00000000e00, 1.05592221e-05],
                [7.61375919e-05, 0.00000000e00, 6.15935887e-06],
                [1.05950765e-06, 0.00000000e00, 3.85444928e-07],
                [7.70639246e-05, 0.00000000e00, 6.23326171e-06],
            ],
        )
