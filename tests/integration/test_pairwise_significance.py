...
class TestOverlapsPairwiseSignificance(TestCase):
    ...
    def test_pairwise_significance_mr_x_mr(self):
        ...
        np.testing.assert_almost_equal(
            slice_.pairwise_significance_t_stats[4],
            [
                [-12.54116375, 7.56184811, -5.27457748, 3.53385563, 0.0, 24.47938693],
                [-10.93005322, 6.63814085, -5.28478257, 2.74674344, 0.0, 21.43016641],
                [-10.40162644, 6.13162263, -6.07814414, 2.24418003, 0.0, 20.58184645],
                [-9.16922509, 5.53344078, -5.23961002, 1.92385911, 0.0, 17.12635694],
                [-11.46156367, 7.30620007, -5.42039101, 3.37768912, 0.0, 23.28282822],
        ...
        np.testing.assert_almost_equal(
            slice_.pairwise_significance_p_vals[4],
            [
                [0, 4.70290473e-13, 2.52686190e-07, 4.72985750e-04, 0, 0],
                [0, 1.45236267e-10, 2.40117375e-07, 6.37681148e-03, 0, 0],
                [0, 2.68978217e-09, 3.62473251e-09, 2.55378042e-02, 0, 0],
                [0, 6.76694401e-08, 3.00783654e-07, 5.53026772e-02, 0, 0],
                [0, 2.41739961e-12, 1.21020634e-07, 8.25816993e-04, 0, 0],
