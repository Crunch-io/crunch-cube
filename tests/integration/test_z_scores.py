...
class TestStandardizedResiduals(TestCase):
    ...
    def test_3d_z_score_with_mr_as_row(self):
        ...
        expected = np.array([
            [[-0.59209185, -1.38186211, -0.61880093,  2.76977489],  # noqa
             [-0.27226001, -0.90729991,  1.19984516,  0.18320768],  # noqa
             [-0.98437766, -1.06099892,  0.00862638,  2.02551167],  # noqa
             [-2.69271055, -0.70247291,  0.97731075,  2.35431028],  # noqa
             [ 2.14156799, -0.26884   , -0.28051055, -1.62988758]],  # noqa

            [[ 0.44613504,  3.10078541, -1.85754165, -1.95161161],  # noqa
             [ 1.47682121, -0.6300945 , -1.37772587,  0.71037862],  # noqa
             [-1.94913113, -1.85068411, -1.08041003,  4.04917418],  # noqa
             [-1.06337882, -0.82946295, -0.13656886,  1.73737263],  # noqa
             [ 3.08099203,  0.23633954, -2.13326401, -1.40411192]],  # noqa

            [[-0.51632005, -0.60341324,  1.08349741,  0.19639231],  # noqa
             [-1.10735911, -0.61498431,  0.48664175,  1.19660131],  # noqa
             [-0.65940873,  1.51305134,  0.17963641, -1.19850121],  # noqa
             [-1.89200746,  1.14283138, -1.54202798,  1.44133862],  # noqa
             [ 2.41917846, -3.08798247,  1.53524725, -1.16466106]],  # noqa

            [[-1.09404899, -1.27933801,      np.nan,  2.80467961],  # noqa
             [ 0.56389782, -1.94631489,  1.32101442,  0.54469167],  # noqa
             [     np.nan,      np.nan,      np.nan,      np.nan],  # noqa
             [ 0.9635808 , -0.95595127,      np.nan,  0.09616004],  # noqa
             [-0.78237941,  1.48226192,      np.nan, -0.70605851]],  # noqa
        ])
        actual = cube.zscore()
        np.testing.assert_almost_equal(actual, expected)
    ...
    def test_3d_z_score_with_mr_as_col(self):
        ...
        expected = np.array([
            [[ 0.01506113, -0.7584501 , -0.02786318, -0.31878531, 0.47399192],  # noqa
             [-0.11623796,  1.1295313 ,  0.42710872,  1.34964387, -1.01589615],  # noqa
             [ 0.60343328, -1.01855773,  0.17035643, -1.87610542, 1.79957599],  # noqa
             [-0.68273333,  0.46006786, -1.32308749, -0.13319154, -1.83163132]],  # noqa

            [[-1.13060031, -0.164368  , -0.7420848 ,  0.67712838, 0.21226447],  # noqa
             [ 1.06695989,  0.44796674,  0.22470228, -0.03843031, 0.10441562],  # noqa
             [ 0.40930073,  0.23774307,  1.63921143,  0.39261527, -1.31335519],  # noqa
             [-0.86324397, -1.34517767, -1.6837454 , -2.67317279, 1.25300357]],  # noqa

            [[ 0.43001972,  1.3126165 , -0.10717325,  1.50608056, 0.65586374],  # noqa
             [-2.54392682, -1.99840816, -0.0500687 , -0.53201525, -1.92602265],  # noqa
             [ 3.30777899,  0.76234711,  0.24895137, -2.36576364, 2.17004946],  # noqa
             [     np.nan,  1.38291283,      np.nan,      np.nan,     np.nan]],  # noqa

            [[ 2.99977078, -0.32043235, -0.34165324,  1.89240508, -0.27546776],  # noqa
             [-4.26735077, -0.58829315,  1.92992202, -1.05792001, 0.03639644],  # noqa
             [ 1.15068951,  1.01695401, -2.17562799, -0.58087799, 0.4756435 ],  # noqa
             [ 2.88459281,  0.44900385, -1.83002841, -1.48069796, -0.19880727]],  # noqa
        ])
        actual = cube.zscore()
        np.testing.assert_almost_equal(actual, expected)
