...
from .fixtures import (
    ...
    IDENTITY_X_PERIOD, LETTERS_X_PETS_HS, MR_X_CAT_HS, MR_X_CAT_X_MR_PRUNE,
    MR_X_CA_HS, PETS_ARRAY, PETS_ARRAY_CAT_FIRST, PETS_ARRAY_SUBVAR_FIRST,
    PETS_ARRAY_X_PETS, PETS_X_FRUIT, PETS_X_PETS, PETS_X_PETS_ARRAY,
    PROFILES_PERCENTS, SCALE_WITH_NULL_VALUES, SELECTED_CROSSTAB_4,
    SIMPLE_CAT_ARRAY, SIMPLE_DATETIME, SIMPLE_TEXT, SINGLE_CAT_MEANS,
...
class TestCrunchCube(TestCase):
    ...
    def test_mr_x_cat_hs_prune_indices(self):
        ...
        actual = cube._prune_indices(transforms=[0, 1])
        np.testing.assert_array_equal(actual[0], expected[0])
        np.testing.assert_array_equal(actual[1], expected[1])
