...
class Describe_PopulationProportions(object):
    ...
    def it_computes_its_blocks(object, request, dimension_types, expected):
        ...
        second_order_measures_ = instance_mock(
            ...
            table_proportions=instance_mock(request, _TableProportions, blocks="table"),
        )
...
class Describe_RowStandardError(object):
    """Unit test suite for `cr.cube.matrix.measure._RowStandardErrors` object."""
...
class Describe_TableWeightedCount(object):
    """Unit test suite for `cr.cube.matrix.measure._TableWeightedCount` object."""
    ...
    def it_knows_if_it_is_defined(self, request, row_dim_type, col_dim_type, expected):
        ...
        assert _TableWeightedCount(dimensions_, None, None).is_defined == expected
    ...
    def it_provides_its_value(self, request, is_defined_prop_):
        ...
        table_margin = _TableWeightedCount(None, None, cube_measures_)
    ...
    def but_it_raises_if_it_is_not_defined(self, is_defined_prop_):
        ...
        with pytest.raises(ValueError) as e:
            _TableWeightedCount(None, None, None).value
    ...
    @pytest.fixture
    def is_defined_prop_(self, request):
        return property_mock(request, _TableWeightedCount, "is_defined")
