...
class _BaseUnweightedCubeValidCounts(_BaseCubeMeasure):
    ...
    def factory(cls, cube, dimensions, slice_idx):
        ...
        Returns None if the cube-result does not include a cube-valid-count-unweighted
        measure.
        """
...
class _BaseWeightedCubeValidCounts(_BaseCubeMeasure):
    ...
    def factory(cls, cube, dimensions, slice_idx):
        ...
        Returns None if the cube-result does not include a cube-valid-count-weighted
        measure.
        """
